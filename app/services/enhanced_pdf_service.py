...
class EnhancedPDFService:
    ...
    def generate_resume_pdf(self, resume_content, user_name="Resume", output_dir="app/output"):
        """Generate a well-formatted PDF from resume content with placeholder filtering"""
        try:
            self.logger.info(f"Starting enhanced PDF generation for: {user_name}")
            ...
            # Clean the content first - remove placeholders
            cleaned_content = self._remove_placeholders(resume_content)
    ...
    def _remove_placeholders(self, content):
        """Remove common placeholder text from the content"""
    ...
    def generate_cover_letter_pdf(self, cover_letter_content, user_name="Cover_Letter", output_dir="app/output"):
        """Generate a well-formatted cover letter PDF"""
        try:
            ...
            # Clean the content first - remove placeholders
            cleaned_content = self._remove_placeholders(cover_letter_content)
