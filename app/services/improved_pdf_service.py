...
class ImprovedPDFService:
    ...
    def generate_resume_pdf(self, resume_content, user_name="Resume", output_dir="app/output"):
        """Generate a well-formatted PDF from resume content"""
        try:
            self.logger.info(f"Starting improved PDF generation for: {user_name}")
            ...
            formatted_sections = self._parse_and_format_resume(resume_content)
    ...
    def generate_cover_letter_pdf(self, cover_letter_content, user_name="Cover_Letter", output_dir="app/output"):
        ...
        try:
            ...
            paragraphs = self._format_cover_letter_content(cover_letter_content)
